...
# Read the data
new_client_df = pd.read_csv(r'C:\Users\jongb\Desktop\yammer_project\alluser_Vs_activated.csv')
new_client_week_df = pd.read_csv(r'C:\Users\jongb\Desktop\yammer_project\weekly_active_user_week.csv')
